...
def parseHTMLByXPath(content):
    ...
    titles = html.xpath('//tr/td[@class="keyword"]/a[@class="list-title"]/text()')
    hrefs = html.xpath('//tr/td[@class="keyword"]/a[@class="list-title"]//@href')
    hots = html.xpath('//tr/td[@class="last"]/span/text()')
